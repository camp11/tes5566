...
if($message['type']=='text') {
  ...
  array (
    ...
    array (
      0 => 
      array (
        'imageUrl' => 'https://stickershop.line-scdn.net/stickershop/v1/sticker/16421558/IOS/sticker_animation@2x.png;compress=true',
        'action' => 
        array (
          'type' => 'message',
          'text' => 'Buka',
...
if($message['type']=='text') {
  ...
  array (
    ...
    array (
      0 => 
      array (
        'imageUrl' => 'https://stickershop.line-scdn.net/stickershop/v1/sticker/16421556/IOS/sticker_animation@2x.png;compress=true',
        'action' => 
        array (
          'type' => 'message',
          'text' => 'Goda',
...
//pesan bergambar
if($message['type']=='text') {
	    if ($command == 'Lebaran' || $command == 'Minal' ) {
        ...
        $balas = array(
            ...
            'messages' => array(
                array (
  'type' => 'imagemap',
  'baseUrl' => 'https://res.cloudinary.com/tes5566/image/upload/v1559482173/line/Lebaran',
  'altText' => 'Selamat Idul Fitri 1440 H',
  'baseSize' => 
  array (
    'height' => 1040,
    'width' => 1040,
  ...
  array (
    ...
    array (
      0 => 
      array (
        'imageUrl' => 'https://stickershop.line-scdn.net/stickershop/v1/sticker/187311825/IOS/sticker_animation@2x.png;compress=true',
        'action' => 
        array (
          'type' => 'message',
          'text' => 'Lebaran',
